...
data = pd.read_csv('/Users/hutianqi/Desktop/Project Cognitive Imprecision/Z9 oTree/ZZ Pilot Testing 2206/Trials_pilot.csv')
...
if len(fitting_pool) != 1 and (fitting_pool[-1] - fitting_pool[0]) == (len(fitting_pool) -1):
    ...
    df_name = 'fDDM_2206P_' + str(fitting_pool[0]) + 'to' + str(fitting_pool[-1])
